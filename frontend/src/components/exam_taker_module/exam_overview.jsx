...
const ExamOverview = () => {
    ...
    const fetchExamInfo = async () => {
      ...
      try {
        ...
        setExamInfo({
          ...
          instructions:
            questionsResponse.data.instructions ||
  ...
  if (loading)
    return (
      <div className="exam-overview-container">Loading exam information...</div>
    );
  if (error)
    return <div className="exam-overview-container error">{error}</div>;
    ...
    <div className="exam-overview-container">
      <div className="exam-overview-card">
        ...
        <table className="exam-table">
          <tbody>
            <tr>
              ...
              <td>{examInfo.startTime}</td>
            </tr>
            <tr>
              <td>
                <strong>End Time:</strong>
              </td>
              <td>{examInfo.endTime}</td>
            </tr>
            <tr>
              <td>
        ...
        <div className="exam-instructions">
          <h3>Instructions:</h3>
          <div className="instruction-content">{examInfo.instructions}</div>
          ...
          <div className="general-instructions">
            ...
            <ul>
              ...
              <li>
                Your answers are saved automatically when you move to another
                question.
              </li>
